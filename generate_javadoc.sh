...
mkdir javadoc/
find src -type d | grep com/apriori/ | sed s/\\//\\./g | sed s/src\\.// | grep -v com.apriori.testing | xargs javadoc -source 6 -classpath bin/:lib/javax.inject.jar:lib/junit-4.10.jar -d javadoc/ -sourcepath src/ -notimestamp -link http://docs.oracle.com/javase/6/docs/api/ -overview src/com/apriori/overview.html
