...
import com.bluegosling.concurrent.ListenableScheduledFutureTaskTest.TestDelayed;
 ...
 * {@link ListenableFutures#makeCompletable(ScheduledFuture)}.
 *
 * @author Joshua Humphries (jhumphries131@gmail.com)
 */
public class MakeListenableScheduledFutureTest extends MakeListenableFutureTest {
   ...
   ListenableScheduledFuture<String> makeFuture(long delay, TimeUnit unit) {
      ...
      return makeListenable(scheduledFuture);
   }
