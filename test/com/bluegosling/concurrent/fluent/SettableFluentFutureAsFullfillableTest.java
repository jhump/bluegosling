...
import com.bluegosling.possible.AbstractPossibleTest;
 ...
 * {@link SettableFluentFuture#asFulfillable()}.
 *
 * @author Joshua Humphries (jhumphries131@gmail.com)
 */
public class SettableFluentFutureAsFullfillableTest extends AbstractPossibleTest {
   @Override
   ...
   protected Fulfillable<String> valueAbsent() {
      return new SettableFluentFuture<String>().asFulfillable();
   }
