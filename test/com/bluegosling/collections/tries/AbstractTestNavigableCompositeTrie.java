...
public abstract class AbstractTestNavigableCompositeTrie extends AbstractTestCompositeTrie {
   

   public AbstractTestNavigableCompositeTrie(String testName) {
      super(testName);
   }

   @Override public abstract NavigableCompositeTrie<List<Object>, Object, Object> makeEmptyMap();
   ...
   public abstract static class BulkTestNavigablePrefixMap
         extends AbstractTestCompositeTrie.BulkTestPrefixMap {

      public BulkTestNavigablePrefixMap(AbstractTestCompositeTrie outer) {
         super(outer);
      }
