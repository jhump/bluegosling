...
public class MethodSignatureTest extends TestCase {
   ...
   /**
    * Tests creating a signature using a name and argument type list.
    * Also tests the accessor methods.
    */
   public void testMethodSignature() {
      MethodSignature sig = new MethodSignature("myMethodName", int.class, String.class, Object[].class);
      
      assertEquals("myMethodName", sig.getName());
      assertEquals(Arrays.<Object> asList(int.class, String.class, Object[].class), sig.getParameterTypes());
   ...
   public void testMethodSignatureNullArgType() {
      ...
      try {
         @SuppressWarnings("unused")
         MethodSignature sig = new MethodSignature("methodName", String.class, int.class, double[].class, null);
      } catch (NullPointerException e) {
         caught = true;
      }
      assertTrue(caught);
   ...
   /**
    * Tests creating a signature using a java.lang.reflect.Method.
    * Also tests the accessor methods.
    * 
    * @throws Exception If reflective method look-up fails
    */
   public void testMethodSignatureForMethod() throws Exception {
      Method m = Arrays.class.getMethod("binarySearch", Object[].class, Object.class, Comparator.class);
      MethodSignature sig = new MethodSignature(m);
      
      assertEquals("binarySearch", sig.getName());
      assertEquals(Arrays.<Object> asList(Object[].class, Object.class, Comparator.class), sig.getParameterTypes());
   }
   ...
   public void testEquals() throws Exception {
      ...
      MethodSignature sig2 = new MethodSignature("binarySearch", Object[].class, Object.class, Comparator.class);
