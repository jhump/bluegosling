 ...
 */
class ShardedConcurrentSet<E> implements Serializable, Cloneable, Set<E> {
   ...
   private class IteratorImpl implements Iterator<E> {
      ...
      public synchronized void remove() {
         if (removed) {
            ...
            removed = true;
            ShardedConcurrentSet.this.remove(lastElement);
         }
      }
   }
    ...
    */
   @SuppressWarnings("unchecked")
   <S extends Set<E> & Cloneable> ShardedConcurrentSet(S set, int concurrency,
         boolean fair) {
   ...
   @Override
   public ShardedConcurrentSet<E> clone() {
      try {
         @SuppressWarnings("unchecked")
         ShardedConcurrentSet<E> copy = (ShardedConcurrentSet<E>) super.clone();
         // deep copy
