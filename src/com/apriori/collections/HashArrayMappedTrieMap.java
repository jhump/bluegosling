 ...
 * 32 bits). Since this structure doesn't use a fixed size array for the mappings (unlike a
...
public abstract class HashArrayMappedTrieMap<K, V> implements Map<K, V> {
