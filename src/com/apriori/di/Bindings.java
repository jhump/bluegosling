...
/**
 * Defines the {@link Binding}s to use for an {@link InjectedEntryPoint}.
 * {@link Provision}s and {@link Binding}s can also be annotated with this
 * to indicate additional {@link Binding}s to include in the entire
