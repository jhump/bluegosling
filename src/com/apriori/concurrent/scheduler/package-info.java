 ...
 * <dl>
 *  <dt>{@link com.apriori.concurrent.scheduler.TaskDefinition}</dt>
 ...
 *  <dt>{@link com.apriori.concurrent.scheduler.ScheduledTaskDefinition}</dt>
 *    <dd>A {@link com.apriori.concurrent.scheduler.TaskDefinition} that has been scheduled for
 *    execution with a {@link com.apriori.concurrent.scheduler.ScheduledTaskManager}. This provides
 ...
 *  <dt>{@link com.apriori.concurrent.scheduler.ScheduledTask}</dt>
 *    <dd>A single invocation of a {@link com.apriori.concurrent.scheduler.ScheduledTaskDefinition}.
 ...
 *  <dt>{@link com.apriori.concurrent.scheduler.RepeatingScheduledTask}</dt>
 *    <dd>Represents all invocations of a repeating
 *    {@link com.apriori.concurrent.scheduler.ScheduledTaskDefinition}. This is for API and
 ...
 * </dl>
 * 
 * <p>Client code uses a {@link com.apriori.concurrent.scheduler.TaskDefinition.Builder} to
 * construct a task and define all of the parameters for its execution. It is then
 * {@linkplain com.apriori.concurrent.scheduler.ScheduledTaskManager#schedule(TaskDefinition) scheduled}
 * with the {@link com.apriori.concurrent.scheduler.ScheduledTaskManager} for execution.
 */
