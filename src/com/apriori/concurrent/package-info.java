 ...
 * <ol>
 * <li>{@link com.apriori.concurrent.ScheduledTaskManager}: Improvements over the
 ...
 * individual instances of recurring tasks.</li>
 * <li>{@link com.apriori.concurrent.ListenableFuture}: {@code Future}s that allow completion
 * callbacks to be registered. This means code has the flexibility of either doing things
 * asynchronously with callbacks or synchronously by blocking for the future to complete.
 * </li>
 * </ol>
 *
