...
public interface Cloner<T> {
   /**
    * Clones an object. Cloning an object copies it, usually a "deep"
    * copy. Cloning can be performed on arguments passed to an interface
    * during verification by an {@link InterfaceVerifier}. This is
    * necessary in the event that the implementation under test mutates
    ...
    * It is expected that, if invoked to clone a null reference, a
