...
public class DescendingCompositeTrie<K, C, V> extends DescendingMap<K, V>
   ...
   @SuppressWarnings("unchecked") // compiler verified type in the constructor
   protected NavigableCompositeTrie<K, C, V> base() {
      return (NavigableCompositeTrie<K, C, V>) super.base();
   }
