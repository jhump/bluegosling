...
public class TransformingMap<KI, VI, KO, VO> implements Map<KO, VO> {
    ...
    * @author Joshua Humphries (jhumphries131@gmail.com)
    */
   public static class ValuesOnly<K, VI, VO> extends TransformingMap<K, VI, K, VO> {
      /**
       * Constructs a new map that wraps the given map, transforming its values using the given
       * function.
       *
       * @param internal the map being wrapped
       * @param fn the function used to produce transformed map values
       */
      public ValuesOnly(Map<K, VI> internal, BiFunction<? super K, ? super VI, ? extends VO> fn) {
   ...
   public static class ReadOnly<KI, VI, KO, VO> extends TransformingMap<KI, VI, KO, VO> {
       ...
       * @author Joshua Humphries (jhumphries131@gmail.com)
       */
      public static class ValuesOnly<K, VI, VO> extends ReadOnly<K, VI, K, VO> {
         /**
          ...
          * @param fn the function used to produce transformed map values
          */
         public ValuesOnly(Map<K, VI> internal,
