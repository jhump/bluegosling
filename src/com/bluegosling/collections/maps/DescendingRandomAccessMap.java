...
import com.bluegosling.collections.sets.TransformingRandomAccessSet;
...
public class DescendingRandomAccessMap<K, V> extends DescendingMap<K, V>
   ...
   @Override protected RandomAccessNavigableMap<K, V> base() {
      return (RandomAccessNavigableMap<K, V>) super.base();
   }
