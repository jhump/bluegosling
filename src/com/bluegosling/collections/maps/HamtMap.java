...
import com.bluegosling.collections.IteratorModifiedState;
 ...
 * structure is an array-mapped bitwise trie where the key bits come from a key's
 * {@linkplain Object#hashCode() hash value}. Like a {@link java.util.HashMap HashMap}, a linked
 * list is used to store values whose keys' hash values collide. But collisions are far less likely
 * than in a {@link java.util.HashMap HashMap} because the full 32 bits of hash value are used (vs.
 * hash value modulo array size, which is typically far lower cardinality than the full 32 bits).
 * 
