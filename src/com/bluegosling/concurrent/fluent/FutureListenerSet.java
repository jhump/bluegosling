...
/**
 * Represents a set of listeners. {@link FluentFuture} implementations can use this class to
 * manage the set of registered listeners.
 *
 * @author Joshua Humphries (jhumphries131@gmail.com)
 *
 * @param <T> the type of result for the fluent future
 */
class FutureListenerSet<T> implements Runnable {
    ...
    */
   FutureListenerSet(FluentFuture<T> future) {
      this.future = future;
   }
    ...
    */
   static <T> void runListener(final FluentFuture<T> future,
