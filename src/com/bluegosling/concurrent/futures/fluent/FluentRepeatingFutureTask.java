...
// TODO: javadoc
public class FluentRepeatingFutureTask<T> extends FluentScheduledFutureTask<T>
      implements FluentRepeatingFuture<T> {
   ...
   public FluentRepeatingFutureTask(Callable<T> callable, long startTimeNanos,
   ...
   public FluentRepeatingFutureTask(Runnable runnable, T result, long startTimeNanos,
         Rescheduler<? super T> rescheduler) {
