...
/**
 * A future task that implements the {@link FluentFuture} interface. This builds on the
 * {@link FutureTask} implementation provided by the Java runtime library and extends it with
 * additional API.
 * 
 * <p>Another implementation of the {@link FluentFuture} interface that doesn't necessarily
 * represent a runnable task is {@link AbstractFluentFuture}. That other class also implements
 ...
 * 
 * @see AbstractFluentFuture
 */
public class FluentFutureTask<T> extends FutureTask<T> implements RunnableFluentFuture<T> {
    ...
    */
   public FluentFutureTask(Callable<T> callable) {
      super(callable);
   }
    ...
    */
   public FluentFutureTask(Runnable runnable, T result) {
