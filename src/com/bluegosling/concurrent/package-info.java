 ...
 * particular note:
 * 
 * <h3>{@link com.bluegosling.concurrent.ListenableFuture}</h3>
 ...
 * 
 * <h3>{@link com.bluegosling.concurrent.SerializingExecutor}</h3>
 ...
 * implementations provided. {@linkplain com.bluegosling.concurrent.PipeliningExecutor One} that wraps a
 * given executor and enforces the parallelism and sequencing independent of the underlying
 * execution mechanism, and {@linkplain com.bluegosling.concurrent.ActorThreadPool another} that is a
 * novel thread pool implementation.
 * 
 * <h3>{@link com.bluegosling.concurrent.HierarchicalLock}</h3>
