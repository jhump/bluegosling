...
enum CoreReflectionTypes implements Types {
   ...
   public boolean isSameType(TypeMirror t1, TypeMirror t2) {
      ...
      if (t2.getKind() != k) {
         ...
         return com.bluegosling.reflect.Types.isSameType(at1.getType(), at2.getType());
      } else {
   ...
   public boolean isSubtype(TypeMirror t1, TypeMirror t2) {
      ...
      return com.bluegosling.reflect.Types.equals(at1.getType(), at2.getType())
            || com.bluegosling.reflect.Types.isSubtype(at1.getType(), at2.getType());
   }
   ...
   public boolean isAssignable(TypeMirror t1, TypeMirror t2) {
      ...
      return com.bluegosling.reflect.Types.isAssignable(type1, type2);
   }
   ...
   private boolean contains(Type type1, Type type2) {
      if (com.bluegosling.reflect.Types.equals(type1, type2)) {
   ...
   private boolean contains(java.lang.reflect.WildcardType type1, Type type2) {
      for (Type bound : type1.getLowerBounds()) {
         if (!com.bluegosling.reflect.Types.isAssignableStrict(bound, type2)) {
            return false;
         }
      }
      
      for (Type bound : type1.getUpperBounds()) {
         if (!com.bluegosling.reflect.Types.isAssignableStrict(type2, bound)) {
            return false;
         }
      }
   ...
   private boolean contains(java.lang.reflect.WildcardType type1,
      ...
      if (lowerBounds.length > 0) {
         ...
         for (Type bound2 : type2.getLowerBounds()) {
            ...
            for (Type bound1 : lowerBounds) {
               if (com.bluegosling.reflect.Types.isAssignableStrict(bound1, bound2)) {
                  isSupertype = true;
                  break;
               }
            }
      ...
      for (Type bound1 : type1.getUpperBounds()) {
         ...
         for (Type bound2 : type2.getUpperBounds()) {
            if (com.bluegosling.reflect.Types.isAssignableStrict(bound2, bound1)) {
               isSupertype = true;
               break;
            }
         }
   ...
   public TypeMirror erasure(TypeMirror t) {
      if (t.getKind() == TypeKind.NULL ||
         ...
         Type erasedType = com.bluegosling.reflect.Types.getErasure(lubType);
         ...
         AnnotatedType at = asAnnotatedTypeAllowVoid(t, "given type");
         Class<?> erased = com.bluegosling.reflect.Types.getErasure(at.getType());
   ...
   public PrimitiveType unboxedType(TypeMirror t) {
      ...
      Class<?> unboxed = com.bluegosling.reflect.Types.unbox(boxed);
      if (boxed == unboxed) {
         throw new IllegalArgumentException();
      }
   ...
   public TypeMirror asMemberOf(DeclaredType containing, Element element) {
      ...
      Class<?> containingClass =
            com.bluegosling.reflect.Types.getErasure(containingType.getType());
