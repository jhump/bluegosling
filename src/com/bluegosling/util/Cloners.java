...
public final class Cloners {
   ...
   public static <T> Cloner<T> withCopyConstructor(Class<T> clazz) {
      ...
      if (cons == null) {
         throw new IllegalArgumentException("No copy constructor exists for "
               + clazz.getName());
      }
    ...
    * {@link com.bluegosling.testing.InterfaceVerifier.MethodConfigurator#cloneArgumentsWith(List)}
    * under situations where some of the method arguments do not need to be cloned (like if they are
    * null, primitive, or not subject to mutation by the method under test).
    * 
    * @param clones The clones
    * @return A list of cloners
